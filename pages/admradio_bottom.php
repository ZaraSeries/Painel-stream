...
if ($online) {
echo '<a href="content.php?include=admradio&view='.$data["id"].'&action=start" TITLE="Server ist nicht gestartet. Hier klicken zum starten!" onClick="return confirm(\'Wollen Sie den Server ' . $data['portbase'] . ' wirklich starten?\')"><img src="./images/inaktiv.gif" alt="Server gestoppt"></a>';

}
else {
echo '<a href="content.php?include=admradio&view='.$data["id"].'&action=stop" TITLE="Server l&auml;uft. Hier klicken zum stoppen!" onClick="return confirm(\'Wollen Sie den Server ' . $data['portbase'] . ' wirklich stoppen?\')"><img src="./images/ok.gif" alt="Server gestartet"></a>';
}

echo '<a href="content.php?include=admradio&action=update&view='.$data["id"].'" TITLE="Server konfigurieren"><img src="./images/edit.gif"></a><a href="content.php?include=admradio&view='.$data["id"].'&action=delete" TITLE="Server l&ouml;schen!!!" onClick="return confirm(\'Wollen Sie den Server ' . $data['portbase'] . ' wirklich l&ouml;schen?\')"><img src="./images/del.gif"></a>';
...
<form method="post" action="content.php?include=admradio&<?php if ($_GET['action'] == "new") {
    ...
    if ($_GET['action'] == "update") {
        ...
        while ($updateget_var = mysql_fetch_array($updateget_data)) {
            ...
            $updateget_var_t_banfile = $updateget_var['banfile'];
            $updateget_var_t_ripfile = $updateget_var['ripfile'];
            ...
            $updateget_var_t_djport_1 = $updateget_var['djport_1'];
            $updateget_var_t_djlogin_1 = $updateget_var['djlogin_1'];
            $updateget_var_t_djpassword_1 = $updateget_var['djpassword_1'];
            $updateget_var_t_djlogin_2 = $updateget_var['djlogin_2'];
            $updateget_var_t_djpassword_2 = $updateget_var['djpassword_2'];
...
<div class="input_field">
    <?php
    $nextdjportq = mysql_query("SELECT djport_1 FROM servers order by djport_1 DESC");
    if (mysql_num_rows($nextdjportq) >= 1)
        $nextdjport = mysql_result($nextdjportq, 0) + 4;
    else
        $nextdjport = "21000";
    ?>
    <label for="a"><?php echo "DJ-Port";?></label>
    <input class="mediumfield" name="djport_1" type="text"<?php if ($_GET['action'] == "update") {
        echo 'disabled="disabled"';
    }?> value="<?php if ($_GET['action'] == "update") {
        echo $updateget_var_t_djport_1;
    } else {
        echo $nextdjport;
    }?>"/>
    <span class="field_desc"><?php echo "DJ-Port";?></span>
</div>
...
<div class="input_field">
    ...
    if (mysql_num_rows($nextportq) >= 1)
        $nextport = mysql_result($nextportq, 0) + 4;
    else
        $nextport = "8000";
    ?>
...
<div class="input_field">
    <label for="a"><?php echo "Banfile";?></label>
    <input class="mediumfield" name="banfile" type="text" value="<?php echo $updateget_var_t_banfile;?>"disabled="disabled"/>
    <span class="field_desc"><?php echo "Banfile";?></span>
</div>
<div class="input_field">
    <label for="a"><?php echo "Ripfile";?></label>
    <input class="mediumfield" name="ripfile" type="text" value="<?php echo $updateget_var_t_ripfile;?>"disabled="disabled"/>
    <span class="field_desc"><?php echo "Ripfile";?></span>
</div>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="bitrate">
        <option value="320000"<?php if ($updateget_var_t_bitrate == '320000') echo " selected=\"selected\"";?>>320 kbps
        </option>
        <option value="256000"<?php if ($updateget_var_t_bitrate == '256000') echo " selected=\"selected\"";?>>256 kbps
        </option>
        <option value="192000"<?php if ($updateget_var_t_bitrate == '192000') echo " selected=\"selected\"";?>>192 kbps
        </option>
        <option value="160000"<?php if ($updateget_var_t_bitrate == '160000') echo " selected=\"selected\"";?>>160 kbps
        </option>
        <option value="128000"<?php if ($updateget_var_t_bitrate == '128000') echo " selected=\"selected\"";?>>128 kbps
        </option>
        <option value="96000"<?php if ($updateget_var_t_bitrate == '96000') echo " selected=\"selected\"";?>>96 kbps
        </option>
        <option value="64000"<?php if ($updateget_var_t_bitrate == '64000') echo " selected=\"selected\"";?>>64 kbps
        </option>
        <option value="56000"<?php if ($updateget_var_t_bitrate == '56000') echo " selected=\"selected\"";?>>56 kbps
        </option>
        <option value="48000"<?php if ($updateget_var_t_bitrate == '48000') echo " selected=\"selected\"";?>>48 kbps
        </option>
        <option value="40000"<?php if ($updateget_var_t_bitrate == '40000') echo " selected=\"selected\"";?>>40 kbps
        </option>
        <option value="32000"<?php if ($updateget_var_t_bitrate == '32000') echo " selected=\"selected\"";?>>32 kbps
        </option>
        <option value="24000"<?php if ($updateget_var_t_bitrate == '24000') echo " selected=\"selected\"";?>>24 kbps
        </option>
        <option value="16000"<?php if ($updateget_var_t_bitrate == '16000') echo " selected=\"selected\"";?>>16 kbps
        </option>
        <option value="8000"<?php if ($updateget_var_t_bitrate == '8000') echo " selected=\"selected\"";?>>8 kbps
        </option>
    </select>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="sitepublic">
        <option value="1"<?php if ($updateget_var_t_sitepublic == '1') echo " selected=\"selected\"";?>><?php echo $messages["add07"]; ?></option>
        <option value="0"<?php if ($updateget_var_t_sitepublic == '0') echo " selected=\"selected\"";?>><?php echo $messages["add08"]; ?></option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="tchlog">
        <option value="no"<?php if ($updateget_var_t_tchlog == 'no') echo " selected=\"selected\"";?>>YP Tracks ignorieren</option>
        <option value="yes"<?php if ($updateget_var_t_tchlog == 'yes') echo " selected=\"selected\"";?>>YP Tracks aufnehmen im Log</option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="weblog">
        <option value="no"<?php if ($updateget_var_t_weblog == 'no') echo " selected=\"selected\"";?>><?php echo $messages["add05"]; ?></option>
        <option value="yes"<?php if ($updateget_var_t_weblog == 'yes') echo " selected=\"selected\"";?>><?php echo $messages["add06"]; ?></option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="w3cenable">
        <option value="no"<?php if ($updateget_var_t_w3cenable == 'no') echo " selected=\"selected\"";?>>W3C Log aus</option>
        <option value="yes"<?php if ($updateget_var_t_w3cenable == 'yes') echo " selected=\"selected\"";?>>W3C Log ein</option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="namelookups">
        <option value="0"<?php if ($updateget_var_t_namelookups == '0') echo " selected=\"selected\"";?>>DNS off</option>
        <option value="1"<?php if ($updateget_var_t_namelookups == '1') echo " selected=\"selected\"";?>>DNS on</option>
    </select>
...
<div class="input_field">
    <label for="a"><?php echo $messages["160"];?></label>
        <select class="formselect_loca" name="publicserver">
        <option value="default"<?php if ($updateget_var_t_publicserver == 'default') echo " selected=\"selected\"";?>>default</option>
        <option value="always"<?php if ($updateget_var_t_publicserver == 'always') echo " selected=\"selected\"";?>>always</option>
        <option value="never"<?php if ($updateget_var_t_publicserver == 'never') echo " selected=\"selected\"";?>>never</option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="allowrelay">
        <option value="1"<?php if ($updateget_var_t_allowrelay == '1') echo " selected=\"selected\"";?>><?php echo $messages["add01"]; ?></option>
        <option value="0"<?php if ($updateget_var_t_allowrelay == '0') echo " selected=\"selected\"";?>><?php echo $messages["add02"]; ?></option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="allowpublicrelay">
        <option value="0"<?php if ($updateget_var_t_allowpublicrelay == '0') echo " selected=\"selected\"";?>><?php echo $messages["add04"]; ?></option>
        <option value="1"<?php if ($updateget_var_t_allowpublicrelay == '1') echo " selected=\"selected\"";?>><?php echo $messages["add03"]; ?></option>
    </select>
...
<div class="input_field">
    ...
    <select class="formselect_loca" name="metainterval">
        <option value="8192"<?php if ($updateget_var_t_metainterval == '8192') echo " selected=\"selected\"";?>>8192</option>
        <option value="32768"<?php if ($updateget_var_t_metainterval == '32768') echo " selected=\"selected\"";?>>32768</option>
    </select>
